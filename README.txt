...
via i2c and uses the TLE (in combination with the 4th order Runge Kutta algorithm) to calculate the rotation
matrices and quaterions that define the orientation of the spacecraft. The implemented algorithms for
the calculation of the attitude (aka orientation) are QUEST and TRIAD. The Q-davenport algorithm is implemented 
in matlab. 
